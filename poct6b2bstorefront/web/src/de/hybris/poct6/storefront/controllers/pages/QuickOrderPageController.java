...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException 
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("poct6b2bstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("poct6b2bstorefront.quick.order.rows.max", 25)));
