	...
	<div class="ASM_header navigation navigation--top">
        <div class="first-top-row row">
            ...
            <c:if test="${not empty asm_message}">
                <div class="ASM_alert ${asm_alert_class}"><spring:theme code="${asm_message}" arguments="${asm_message_args}" htmlEscape="true"/></div>
            </c:if>
                            ...
                            <span class="ASM_loggedin_agent_store_name">
                                ...
                                <c:if test="${not empty asm_agent_store}">
                                    <p>
                                        ...
                                        <span class="ASM_loggedin_text_name"><spring:theme code="${asm_agent_store}" htmlEscape="true"/></span>
                                    </p>
                                </c:if>
                            </span>
