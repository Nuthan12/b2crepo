...
<%@ attribute name="returnLabelDownloadHtml" required="false" type="java.lang.String" %>
        ...
        <c:if test="${not empty returnRequest.returnLabelDownloadUrl && returnRequest.cancellable}">
            <div class="return-details-actions">
                <div class="col-sm-4 col-md-3 col-lg-3 pull-right">
                    <a href="${fn:escapeXml(returnLabelDownloadHtml != null ? returnLabelDownloadHtml : returnRequest.returnLabelDownloadUrl)}" download="ShippingLabel">
