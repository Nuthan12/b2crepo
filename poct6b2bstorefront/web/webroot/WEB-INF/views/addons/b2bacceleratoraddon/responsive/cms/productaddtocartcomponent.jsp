...
<div class="addtocart-component">
    <c:if test="${empty showAddToCart ? true : showAddToCart}">
        <div class="qty-selector input-group js-qty-selector">
            ...
            <input type="text" maxlength="3" class="form-control js-qty-selector-input" size="1" value="${qtyMinus}" data-max="${fn:escapeXml(maxQty)}" data-min="1" name="pdpAddtoCartInput"  id="pdpAddtoCartInput" aria-label="${text.quantity}"/>
			<span class="input-group-btn">
    ...
    <div class="actions">
        <c:if test="${multiDimensionalProduct}" >
                ...
                <a href="${fn:escapeXml(productOrderFormUrl)}" class="btn btn-default btn-block btn-icon js-add-to-cart glyphicon-list-alt">
