    ...
    <div class="account-section-content ">
        ...
        <div class="account-overview-table replenishment-overview-table">
            <table class="responsive-table">
                <caption content="text.account.replenishment.page"></caption>
                <thead>
                    <tr class="responsive-table-head hidden-xs">
                        <th scope="col"><spring:theme code="text.account.replenishment.replenishmentNumber"/></th>
                        <th scope="col"><spring:theme code="text.account.replenishment.purchaseOrderNumber"/></th>
                        <th scope="col"><spring:theme code="text.account.replenishment.startDate"/></th>
                        <th scope="col"><spring:theme code="text.account.replenishment.Schedule"/></th>
                        <th scope="col"><spring:theme code="text.account.replenishment.nextOrderDate"/></th>
                        <th scope="col"><spring:theme code="text.account.replenishment.creationDate"/></th>
                        <th scope="col"><spring:theme code="text.account.replenishment.total"/></th>
                        <th scope="col"><spring:theme code="text.account.replenishment.actions"/></th>
                    </tr>
                </thead>
                <tbody>
