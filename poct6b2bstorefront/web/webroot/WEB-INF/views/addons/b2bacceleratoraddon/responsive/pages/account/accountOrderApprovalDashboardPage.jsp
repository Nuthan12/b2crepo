		...
		<div class="account-orderhistory">
			...
			<div class="responsive-table">
				<table id="order_history" class="responsive-table">
					<caption content="text.account.orderHistory.page"></caption>
					<thead>
						<tr class="responsive-table-head hidden-xs">
							<th scope="col"><spring:theme code="text.account.orderApprovalDashBoard.orderNumber" /></th>
							<th scope="col"><spring:theme code="text.account.orderApprovalDashBoard.purchaseOrderNumber" /></th>
							<th scope="col"><spring:theme code="text.account.orderApprovalDashBoard.orderStatus" /></th>
							<th scope="col"><spring:theme code="text.account.orderApprovalDetails.orderPlacedBy" /></th>
							<th scope="col"><spring:theme code="text.account.orderHistory.datePlaced" /></th>
							<th scope="col"><spring:theme code="text.account.order.total" /></th>
						</tr>
					</thead>
					<tbody>
