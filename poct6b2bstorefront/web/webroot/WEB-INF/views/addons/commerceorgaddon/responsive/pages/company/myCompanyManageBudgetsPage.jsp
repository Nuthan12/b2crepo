			...
			<div class="account-section-content">
                ...
                <div class="account-overview-table">
                    <table class="responsive-table">
                        <caption content="text.company.budget.page"></caption>
                        <tr class="responsive-table-head hidden-xs">
                            <th scope="col"><spring:theme code="text.company.column.id.name"/></th>
                            ...
                            <th scope="col"><spring:theme code="text.company.manage.units.costCenters"/></th>
                            <th scope="col"><spring:theme code="text.company.budget.amount"/></th>
                            <th scope="col"><spring:theme code="text.company.budget.start"/></th>
                            <th scope="col"><spring:theme code="text.company.budget.end"/></th>
                            <th scope="col"><spring:theme code="text.company.column.status.name"/></th>
                        </tr>
