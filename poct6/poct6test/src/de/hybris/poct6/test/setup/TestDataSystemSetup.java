 ...
 */
package de.hybris.poct6.test.setup;
...
import de.hybris.poct6.test.constants.Poct6TestConstants;
import de.hybris.poct6.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Poct6TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/poct6test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/poct6test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/poct6test/import/cstickets.impex");
			...
			importImpexFile(context, "/poct6test/import/csquotes.impex");
		}
	}
}
