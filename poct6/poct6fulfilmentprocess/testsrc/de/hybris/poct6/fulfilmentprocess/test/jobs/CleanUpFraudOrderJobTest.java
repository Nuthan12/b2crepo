 ...
 */
package de.hybris.poct6.fulfilmentprocess.test.jobs;
...
import de.hybris.poct6.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = Poct6FulfilmentProcessConstants.ORDER_PROCESS_NAME;
