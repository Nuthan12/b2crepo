...
public class ChineseDeliveryAddressCheckoutStepController extends DeliveryAddressCheckoutStepController
{
	...
	public String doSelectSuggestedAddress(final AddressForm addressForm, final RedirectAttributes redirectModel)
	{
		...
		final ChineseAddressForm chineseAddressForm = getChineseAddressForm(addressForm);
	...
	private ChineseAddressForm getChineseAddressForm(final AddressForm addressForm)
	{
		...
		if (CHINA_ISOCODE.equals(addressForm.getCountryIso()) && request != null)
		{
