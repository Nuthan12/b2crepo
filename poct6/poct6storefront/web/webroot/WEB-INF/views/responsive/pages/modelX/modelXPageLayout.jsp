  ...
  <body>
    <div class="row models">
        ...
        <div id="myCarousel" class="carousel carousel-dark slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://tesla-cdn.thron.com/delivery/public/image/tesla/37612e96-a8a7-46ea-9847-4fff683483b0/bvlatuR/std/2880x1800/Model-X-Main-Hero-Desktop-LHD?quality=auto-medium&amp;format=auto" class="d-block w-100" alt="Your Image 1" />
            </div>
          </div>
      ...
      <div class="col-lg-4 col-md-12" style="max-height: 710px; overflow-y: scroll; margin-top: 4.5rem; text-align: center;">
        <h1>Model X</h1>
        <h6>Model X Dual Motor All-Wheel Drive</h6>
        <br />
        <table class="desc-tbl">
          <tr class="thead">
            <th><h4><b>485 mi</b></h4></th>
            <th><h4><b>160 mph</b></h4></th>
