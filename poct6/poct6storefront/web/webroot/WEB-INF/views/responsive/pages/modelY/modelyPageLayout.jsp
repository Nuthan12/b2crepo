  ...
  <body>
    <div class="row models">
        ...
        <div id="myCarousel" class="carousel carousel-dark slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://tesla-cdn.thron.com/delivery/public/image/tesla/dfa1ee09-8585-422e-a32a-067e14159aa0/bvlatuR/std/2880x2400/Homepage-Model-Y-Global-Desktop?quality=auto-medium&amp;format=auto" class="d-block w-100" alt="Your Image 1" />
            </div>
          </div>
      ...
      <div class="col-lg-4 col-md-12" style="max-height: 710px; overflow-y: scroll; margin-top: 4.5rem; text-align: center;">
        <h1>Model Y</h1>
        <h6>Model Y Dual Motor All-Wheel Drive</h6>
        <br />
        <table class="desc-tbl">
          <tr class="thead">
            <th><h4><b>330 mi</b></h4></th>
            <th><h4><b>165 mph</b></h4></th>
...
<li>Ultra Blue</li>
<li>Second row with adjustable seatbacks</li>
<li>Black and White Premium Interior with Walnut Décor</li>
<li>Yoke Steering</li>
<li>Electronic fold-flat releases in trunk</li>
...
<br />
<button className="btn btn-secondary">Demo Drive</button>
</div>
</div>
    </div>
