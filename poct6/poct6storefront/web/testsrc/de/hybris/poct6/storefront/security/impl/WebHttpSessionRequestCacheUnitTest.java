...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/poct6storefront/electronics/en",
						"https://electronics.local:9002/poct6storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/poct6storefront/electronics/en",
						"https://electronics.local:9002/poct6storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/poct6storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/poct6storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/poct6storefront/electronics/en",
						"https://electronics.local:9002/poct6storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/poct6storefront",
						"https://electronics.local:9002/poct6storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/poct6storefront",
						"https://electronics.local:9002/poct6storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/poct6storefront/electronics/en",
						"https://electronics.local:9002/poct6storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
